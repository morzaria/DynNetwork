...
/**
 * <code> ForceSimulator </code> manages a simulation of physical forces acting on bodies. To create a
...
public class ForceSimulator 
{
    ...
    /**
     * <code> ForceSimulator </code> constructor. 
     * A RungeKuttaIntegrator is used by default.
     */
    ...
    {
        return addSpring(item1, item2, -1.f, -1.f, -1.f);
    }
    ...
    {
        return addSpring(item1, item2, -1.f, -1.f, length);
    }
     ...
     * @param damp the spring damping coefficient
     * @param length the spring length
     * @return the Spring added to the simulation
     */
    public Spring addSpring(ForceItem item1, ForceItem item2, float coeff, float damp, float length) 
    {
