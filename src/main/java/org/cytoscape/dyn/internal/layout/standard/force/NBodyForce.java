...
/**
 * <code> NBodyForce </code> is a force function which computes an n-body force such as gravity,
...
public class NBodyForce extends AbstractForce 
{
    ...
    public static final float DEFAULT_GRAV_CONSTANT = -5f;
    ...
    /**
     * <code> NBodyForce </code> constructor.
     */
    public NBodyForce() 
    {
