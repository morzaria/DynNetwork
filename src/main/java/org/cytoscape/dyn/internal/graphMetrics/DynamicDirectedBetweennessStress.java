...
public class DynamicDirectedBetweennessStress<T> extends AbstractTask{
	 ...
	 * @param dynNetManager
	 */
	public DynamicDirectedBetweennessStress(DynNetworkViewManagerImpl<T> dynNetViewManager, CyNetworkView cyNetworkView, CyNetworkFactory cyNetworkFactoryServiceRef, CyRootNetworkManager cyRootNetworkManagerServiceRef, CyNetworkNaming cyNetworkNamingServiceRef, DynNetworkManagerImpl<T> dynNetManager){
